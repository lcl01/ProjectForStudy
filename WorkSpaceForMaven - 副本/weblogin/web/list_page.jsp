    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${pageBean.list}" var="u">
            <tr>
                ...
                <td>${u.qq}</td>
                <td>${u.email}</td>
                <td><a class="btn btn-default btn-sm" href="修改联系人.html">修改</a>&nbsp;<a class="btn btn-default btn-sm" onclick="deleteById(${u.id})">删除</a></td>
            </tr>
        </c:forEach>
        <tr>
            <td colspan="8" align="center">
				<ul class="pagination success">
                    ...
                    <c:if test="${pageBean.curPage > 1}">
					    <li><a href="userServlet03?method=findByPage&curPage=${pageBean.curPage-1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
                    </c:if>
                    ...
                    <c:forEach begin="1" end="${pageBean.sumPage}" var="n">
                        ...
                        <c:if test="${pageBean.curPage != n}">
                            <li><a href="userServlet03?method=findByPage&curPage=${n}">${n}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:if test="${pageBean.curPage < pageBean.sumPage}">
					    <li><a href="userServlet03?method=findByPage&curPage=${pageBean.curPage+1}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
                    </c:if>
        ...
        <script>
            function deleteById(id) {
                ...
                if (flag) {
                    location.href="userServlet03?method=delete&id="+id;
                }
