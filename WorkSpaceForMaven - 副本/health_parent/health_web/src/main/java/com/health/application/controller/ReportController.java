...
public class ReportController {
    ...
    public Result exportBusinessReport(HttpServletRequest request, HttpServletResponse response)throws Exception{
        try {
            ...
            row = sheet.getRow(7);
            row.getCell(5).setCellValue(todayOrderNumber);//本周新增会员数
            row.getCell(7).setCellValue(todayVisitsNumber);//本月新增会员数
            ...
            response.setHeader("context-Disposition","attachment;filename=report.xls");
